...
Below is a simple boxplot looking at the body mass of all of the penguins in the Palmer Penguins dataset. You can also add titles and axis labels to boxplots, this is accomplished in the same format as in the scatterplots.
```{r}
require(palmerpenguins)
penguins<- penguins
...
catrate = read.csv(here("data", "catrate.csv"))# "here" allows you to find the data on your computer. "dat" is the folder that the the catrate.csv file is saved.
```
